...
if __name__ == "__main__":
    ...
    parser.add_argument('--iterations', type=int, default=425001)  # wp 850001  wi 300001
    ...
    args = parser.parse_args('wp2.0225 --batch-sizes 2 2 --seq-lens 512 1024 --fp16'.split())
